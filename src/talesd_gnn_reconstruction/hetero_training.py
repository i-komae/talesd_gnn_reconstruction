...
def _scaler_cache_metadata(
    ...
    *,
    ...
    return {
        ...
        "raw_columns_json": str(getattr(dataset, "columns_json", "{}")),
    ...
    def _runtime_payload(
        *,
        ...
        return {
            ...
            "target_columns": list(target_columns_for_mode(core_target_mode)),
            "raw_columns_json": str(getattr(base_dataset, "columns_json", "{}")),
            "columns_json": str(getattr(base_dataset, "columns_json", "{}")),
            "detector_feature_columns": list(coordinate_summary["detector_feature_columns"]),
            "pulse_feature_columns": list(coordinate_summary["pulse_feature_columns"]),
            "effective_detector_feature_columns": list(coordinate_summary["detector_feature_columns"]),
