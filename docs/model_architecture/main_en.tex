...
Figures~\ref{fig:en-input-node}, \ref{fig:en-input-edge}, and~\ref{fig:en-input-pulse-waveform-target} show input distributions generated from the current \code{flat50000\_wfmask\_target6\_20260603\_102418} HDF5 export.
...
The realized event fractions are 81.0\%, 7.37\%, and 11.6\%, while the source-path fractions are 69.3\%, 10.1\%, and 20.6\%.
The event fractions differ from the nominal target because the split preserves source-path separation.
...
\begin{figure}[p]
  ...
  \caption{Accepted-pulse node-feature distributions from the current \code{flat50000\_wfmask\_target6\_20260603\_102418} HDF5 export.}
...
\begin{figure}[p]
  ...
  \caption{Edge-feature distributions from the current \code{flat50000\_wfmask\_target6\_20260603\_102418} HDF5 export.}
...
\begin{figure}[p]
  ...
  \caption{Waveform-feature and reconstruction-target distributions from the current \code{flat50000\_wfmask\_target6\_20260603\_102418} HDF5 export.}
