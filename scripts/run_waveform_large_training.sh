...
GRAPH_OUTPUT="${GRAPH_OUTPUT:-${GRAPH_DIR}/${RUN_NAME}.h5}"
...
ENERGY_OVERSAMPLE_FACTOR="${ENERGY_OVERSAMPLE_FACTOR:-2.0}"
...
mkdir -p "${CHECKPOINT_DIR}" "${LOG_DIR}" "${CONFIG_DIR}" "${SUMMARY_DIR}" "${GRAPH_DIR}"
