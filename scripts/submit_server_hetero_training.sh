...
export MODEL_ARCHITECTURE="${MODEL_ARCHITECTURE:-minimal_hetero}"
...
export USE_PULSE_PARENT_WAVEFORM="${USE_PULSE_PARENT_WAVEFORM:-1}"
export USE_PULSE_BOUNDS="${USE_PULSE_BOUNDS:-1}"
export PULSE_WAVEFORM_ENCODER="${PULSE_WAVEFORM_ENCODER:-crop_cnn}"
export USE_RELATIVE_POSITIONS="${USE_RELATIVE_POSITIONS:-1}"
export DETECTOR_READOUT_MASK="${DETECTOR_READOUT_MASK:-signal}"
export PULSE_READOUT_MASK="${PULSE_READOUT_MASK:-all}"
...
export HETERO_RELATION_PRESET="${HETERO_RELATION_PRESET:-minimal}"
...
export MILESTONE_EVAL_SPLIT="${MILESTONE_EVAL_SPLIT:-validation test}"
export MILESTONE_EVAL_MAX_GRAPHS="${MILESTONE_EVAL_MAX_GRAPHS:-0}"
export MILESTONE_EVAL_CURRENT_MODEL="${MILESTONE_EVAL_CURRENT_MODEL:-0}"
export MILESTONE_EVAL_BEST_MODEL="${MILESTONE_EVAL_BEST_MODEL:-1}"
export MILESTONE_EVAL_DIAGNOSTICS="${MILESTONE_EVAL_DIAGNOSTICS:-1}"
