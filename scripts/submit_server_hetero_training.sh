...
export PULSE_WAVEFORM_ENCODER="${PULSE_WAVEFORM_ENCODER:-bounds}"
export DETECTOR_READOUT_MASK="${DETECTOR_READOUT_MASK:-all}"
...
export HETERO_RELATION_PRESET="${HETERO_RELATION_PRESET:-}"
